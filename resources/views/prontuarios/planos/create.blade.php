@extends('layouts.app')
@section('title', 'Novo Plano Terapêutico')
@section('page-title', 'Novo Plano Terapêutico — ' . $prontuario->paciente->nome)
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <form action="{{ route('prontuarios.planos.store', $prontuario) }}" method="POST">
            @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="titulo"
                                   ...
                                   placeholder="Ex: Plano TEA — 1º Semestre 2026"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="periodo_inicio"
                                   value="{{ old('periodo_inicio', today()->format('Y-m-d')) }}"
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <div id="especialidades-container">
                        @forelse(old('especialidades', []) as $i => $esp)
...
{{-- Template oculto para nova linha de especialidade --}}
...
<script>
(function () {
    let index = {{ count(old('especialidades', [])) }};
    ...
    // Bind existing rows (after old() restore)
